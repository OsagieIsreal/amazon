  ...
  return (
    <Box width="90%">
      ...
      <Box backgroundColor="red" width="90%" display="flex" justifySelf="center" marginBottom="10px">
            <Link fontSize="4xl" fontWeight="bold" color="White" href='login'>Best selling in Homes and Kitchen <Image src={BottomTN} alt="Sample Image"></Image></Link>        
      </Box>
      <Box backgroundColor="red" width="90%" display="flex" justifySelf="center" marginBottom="10px">
            <Link fontSize="4xl" fontWeight="bold" color="White" href='login'>Best seller in Computer & Assesories <Image src={BottomTN} alt="Sample Image"></Image></Link>
